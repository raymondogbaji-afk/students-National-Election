...
-- Create multiple candidates from an admin-uploaded spreadsheet.
-- p_candidates: jsonb array of {"position": "<position title>", "name": "...", "institution": "...", "profile": "..."}
-- The position is resolved by title (case-insensitive) within the election.
-- Zone is derived from the position (zonal positions only).
